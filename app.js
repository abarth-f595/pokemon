...
// --- 砕けすぎた表現の修正ルール ---
const CASUAL_RULES = [
    // 口語的な縮約形（〜てる/〜てた/〜とく/〜ちゃう系）
    { re: /してる/g,           rep: 'している',           reason: '「してる」→「している」に修正しました' },
    { re: /してた/g,           rep: 'していた',           reason: '「してた」→「していた」に修正しました' },
    { re: /してく/g,           rep: 'していく',           reason: '「してく」→「していく」に修正しました' },
    { re: /しとく/g,           rep: 'しておく',           reason: '「しとく」→「しておく」に修正しました' },
    { re: /しちゃった/g,       rep: 'してしまいました',   reason: '「しちゃった」→「してしまいました」に修正しました' },
    { re: /しちゃう/g,         rep: 'してしまう',         reason: '「しちゃう」→「してしまう」に修正しました' },
    { re: /できちゃう/g,       rep: 'できてしまう',       reason: '縮約形を修正しました' },
    { re: /なっちゃう/g,       rep: 'なってしまう',       reason: '縮約形を修正しました' },
    { re: /なっちゃった/g,     rep: 'なってしまいました', reason: '縮約形を修正しました' },
    { re: /来ちゃった/g,       rep: '来てしまいました',   reason: '縮約形を修正しました' },
    { re: /行っちゃった/g,     rep: '行ってしまいました', reason: '縮約形を修正しました' },
    { re: /やっちゃった/g,     rep: 'やってしまいました', reason: '縮約形を修正しました' },

    // 「っていう」「ていうか」系
    { re: /っていう/g,         rep: 'という',             reason: '「っていう」→「という」に修正しました' },
    { re: /っていった/g,       rep: 'といった',           reason: '「っていった」→「といった」に修正しました' },
    { re: /ていうか/g,         rep: 'また',               reason: '「ていうか」はカジュアルです。「また」に修正しました' },
    { re: /^てか[、\s]/gm,     rep: 'それよりも、',       reason: '「てか」はカジュアルです' },

    // 〜とか・〜みたいな
    { re: /とか([、。])/g,     rep: 'など$1',             reason: '「とか」→「など」に修正しました' },
    { re: /みたいな/g,         rep: 'のような',           reason: '「みたいな」→「のような」に修正しました' },
    { re: /みたいに/g,         rep: 'のように',           reason: '「みたいに」→「のように」に修正しました' },
    { re: /みたいで/g,         rep: 'のようで',           reason: '「みたいで」→「のようで」に修正しました' },
    { re: /ぽい/g,             rep: 'のような',           reason: '「〜ぽい」→「〜のような」に修正しました' },

    // スラング・俗語
    { re: /めちゃくちゃ/g,     rep: '非常に',             reason: '「めちゃくちゃ」はカジュアルです。「非常に」に修正しました' },
    { re: /めちゃ/g,           rep: '非常に',             reason: '「めちゃ」はカジュアルです。「非常に」に修正しました' },
    { re: /超(?=[^\w])/g,      rep: '非常に',             reason: '「超〜」はカジュアルです。「非常に」に修正しました' },
    { re: /マジで/g,           rep: '本当に',             reason: '「マジで」はカジュアルです。「本当に」に修正しました' },
    { re: /マジ(?=[、。\s！])/g, rep: '本当に',           reason: '「マジ」はカジュアルです。「本当に」に修正しました' },
    { re: /ヤバい/g,           rep: '深刻な',             reason: '「ヤバい」はカジュアルです。「深刻な」に修正しました' },
    { re: /ヤバ(?=[い！。、])/g, rep: '非常に問題',       reason: '「ヤバ」はカジュアルです' },
    { re: /ぶっちゃけ/g,       rep: '率直に申しますと',   reason: '「ぶっちゃけ」はカジュアルです' },
    { re: /普通に/g,           rep: '通常',               reason: '「普通に」はカジュアルです。「通常」に修正しました' },
    { re: /全然(?=[^〜])/g,    rep: 'まったく',           reason: '「全然」→「まったく」に修正しました' },
    { re: /なんか(?!の)/g,     rep: '何か',               reason: '「なんか」→「何か」に修正しました' },
    { re: /なんで(?!す|きる|も)/g, rep: 'ですので',       reason: '「なんで」→「ですので」に修正しました' },
    { re: /一応/g,             rep: '念のため',           reason: '「一応」→「念のため」に修正しました' },

    // 文末の終助詞・じゃない系
    { re: /じゃないですか。/g, rep: 'ではないでしょうか。', reason: '「じゃないですか」→「ではないでしょうか」に修正しました' },
    { re: /じゃないか。/g,     rep: 'ではないでしょうか。', reason: '「じゃないか」→「ではないでしょうか」に修正しました' },
    { re: /じゃない。/g,       rep: 'ではありません。',    reason: '「じゃない」→「ではありません」に修正しました' },
    { re: /じゃないかと/g,     rep: 'ではないかと',        reason: '「じゃない」→「ではない」に修正しました' },
    { re: /ですよね。/g,       rep: 'ですね。',            reason: '終助詞「よ」を削除しました' },
    { re: /ますよね。/g,       rep: 'ますね。',            reason: '終助詞「よ」を削除しました' },
    { re: /ですよ。/g,         rep: 'です。',              reason: '終助詞「よ」を削除しました' },
    { re: /ますよ。/g,         rep: 'ます。',              reason: '終助詞「よ」を削除しました' },
];
